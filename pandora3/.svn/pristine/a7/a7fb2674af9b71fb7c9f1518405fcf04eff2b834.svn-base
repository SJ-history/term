...
/**
 * BaseTsysOrgBtnRolRtnn - ValueObject class for table [TSYS_ORG_BTN_ROL_RTNN].
 *
 * <pre>
 ...
 * @since 2019. 03. 13
 */
public class BaseTsysOrgBtnRolRtnn extends CommonBean
{
	/** rol_id (ROL_ID) */
