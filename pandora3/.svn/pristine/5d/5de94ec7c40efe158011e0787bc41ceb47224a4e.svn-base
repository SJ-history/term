...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTbMetaPjtM;

/**
 * TbMetaPjtM - ValueObject Extended class for table [TB_META_PJT_M].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class TbMetaPjtM extends BaseTbMetaPjtM {
	/** crtr_id (CRTR_ID) */
