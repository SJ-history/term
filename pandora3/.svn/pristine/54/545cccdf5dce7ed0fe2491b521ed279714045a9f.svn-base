...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTbMetaCmpnyWrkSysDbM;

/**
 * TbMetaCmpnyWrkSysDbM - ValueObject Extended class for table [TB_META_CMPNY_WRK_SYS_DB_M].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class TbMetaCmpnyWrkSysDbM extends BaseTbMetaCmpnyWrkSysDbM {
	/** crtr_id (CRTR_ID) */
