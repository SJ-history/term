...
/**
 * TsysAdmMnuBtnRtnn - ValueObject class for table [TSYS_ADM_MNU_BTN_RTNN].
 *
 * <pre>
 * 1. 클래스명 : TsysAdmMnuBtnRtnn
 * 2. 설명 : BASE, 권리자메뉴버튼할당 DTO
 * 3. 작성일 : 2019-03-12
 * 4. 작성자 : TANINE
 * </pre>
 *
 * @since 2019. 03. 12
 */
public class BaseTsysAdmMnuBtnRtnn extends CommonBean
{
	/** usr_id (USR_ID) */
