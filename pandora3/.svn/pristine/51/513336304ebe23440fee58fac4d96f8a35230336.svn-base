...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTbMetaCmpnyTbTypD;

/**
 * TbMetaCmpnyTbTypD - ValueObject Extended class for table [TB_META_CMPNY_TB_TYP_D].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class TbMetaCmpnyTbTypD extends BaseTbMetaCmpnyTbTypD {
	/** crtr_id (CRTR_ID) */
