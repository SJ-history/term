...
/**
 * BaseTbLgapMnurtnnH - ValueObject class for table [TB_LGAP_MNURTNN_H].
 *
 * <pre>
 ...
 * @since 2019. 12. 06
 */
public class BaseTbLgapMnurtnnH extends CommonBean
{
	/** hist_no (hist_no) */
	private int hist_no;
