...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTbPdrCmpnyDivM;

/**
 * TbPdrCmpnyDivM - ValueObject Extended class for table [TB_PDR_CMPNY_DIV_M].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class TbPdrCmpnyDivM extends BaseTbPdrCmpnyDivM {
	/** crtr_id (CRTR_ID) */
