...
/**
 * BaseTsysAdmOrgGrpRolRtnn - ValueObject class for table [TSYS_ADM_ORG_GRP_ROL_RTNN].
 *
 * <pre>
 ...
 * @since 2019. 10. 29
 */
public class BaseTsysAdmOrgGrpRolRtnn extends CommonBean
{
	/** org_cd (org_cd) */
	...
	public BaseTsysAdmOrgGrpRolRtnn()
	{
		super();
