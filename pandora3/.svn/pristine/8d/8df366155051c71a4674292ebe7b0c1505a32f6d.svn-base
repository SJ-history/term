...
/**
 * BaseTbPdrCmpnyTechStafjobD - ValueObject class for table [TB_PDR_CMPNY_TECH_STAFJOB_D].
 *
 * <pre>
 ...
 * @since 2020. 05. 21
 */
public class BaseTbPdrCmpnyTechStafjobD extends CommonBean
{
	/** cmpny_cd (CMPNY_CD) */
	private String cmpny_cd;
	/** tech_stafjob_cd (TECH_STAFJOB_CD) */
	private String tech_stafjob_cd;
	/** tech_stafjob_nm (TECH_STAFJOB_NM) */
	private String tech_stafjob_nm;
	/** tech_stafjob_rmk (TECH_STAFJOB_RMK) */
	private String tech_stafjob_rmk;
	/** us_yn (US_YN) */
	...
	public BaseTbPdrCmpnyTechStafjobD()
	{
		super();
	...
	public String getTech_stafjob_nm() { 
		return tech_stafjob_nm; 
	}
	public void setTech_stafjob_nm(String tech_stafjob_nm) {
		this.tech_stafjob_nm = tech_stafjob_nm; 
	}

	public String getTech_stafjob_rmk() { 
		return tech_stafjob_rmk; 
	}
	public void setTech_stafjob_rmk(String tech_stafjob_rmk) {
		this.tech_stafjob_rmk = tech_stafjob_rmk; 
	}
