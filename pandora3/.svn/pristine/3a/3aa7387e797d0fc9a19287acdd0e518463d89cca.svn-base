...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTsysLogInf;

/**
 * TsysLogInf - ValueObject Extended class for table [TSYS_LOG_INF].
 *
 * <pre>
