...
/**
 * BaseTbLgapPgminfH - ValueObject class for table [TB_LGAP_PGMINF_H].
 *
 * <pre>
 ...
 * @since 2020. 01. 13
 */
public class BaseTbLgapPgminfH extends CommonBean
{
	/** hist_no (hist_no) */
	private int hist_no;
	...
	public String getTrg_url() { 
		return trg_url; 
	}
	public void setTrg_url(String trg_url) {
