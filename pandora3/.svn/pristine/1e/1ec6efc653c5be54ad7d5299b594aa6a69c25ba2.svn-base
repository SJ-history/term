...
/**
 * BaseTbLgapGrprolrtnnH - ValueObject class for table [TB_LGAP_GRPROLRTNN_H].
 *
 * <pre>
 ...
 * @since 2019. 11. 28
 */
public class BaseTbLgapGrprolrtnnH extends CommonBean
{
	/** hist_no (hist_no) */
	private int hist_no;
