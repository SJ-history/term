...
import kr.co.ta9.pandora3.pcommon.dto.base.BaseTbMetaObjCdM;

/**
 * TbMetaObjCdM - ValueObject Extended class for table [TB_META_OBJ_CD_M].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class TbMetaObjCdM extends BaseTbMetaObjCdM {
	/** crtr_id (CRTR_ID) */
