...
/**
* <pre>
* 1. 패키지명 : kr.co.ta9.pandora3.display.dto
* 2. 타입명 : class
* 3. 작성일 : 2019-11-06
* 4. 설명 : 조직 tree dto
* </pre>
*/
public class TsysOrgTree extends SimpleBeanInfo{

	
	private String id;					// 자식(본인)
	private String pId;				// 부모
	...
	public String getChildren_yn() {
		return children_yn;
	}
	public void setChildren_yn(String children_yn) {
		this.children_yn = children_yn;
	}
