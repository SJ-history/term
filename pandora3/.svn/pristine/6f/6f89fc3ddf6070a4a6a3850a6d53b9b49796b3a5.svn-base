...
/**
 * BaseTbMetaTbTypCdM - ValueObject class for table [TB_META_TB_TYP_CD_M].
 *
 * <pre>
 ...
 * @since 2020. 05. 20
 */
public class BaseTbMetaTbTypCdM extends CommonBean
{
	/** cmpny_cd (CMPNY_CD) */
	...
	public String getTb_typ_nm() { 
		return tb_typ_nm; 
	}
	public void setTb_typ_nm(String tb_typ_nm) {
		this.tb_typ_nm = tb_typ_nm; 
	}
