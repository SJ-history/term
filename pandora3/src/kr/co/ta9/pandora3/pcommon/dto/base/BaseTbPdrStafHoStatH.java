...
/**
 * BaseTbPdrStafHoStatH - ValueObject class for table [TB_PDR_STAF_HO_STAT_H].
 *
 * <pre>
 ...
 * @since 2020. 05. 21
 */
public class BaseTbPdrStafHoStatH extends CommonBean
{
	/** cmpny_cd (CMPNY_CD) */
	...
	public String getAlt_day() { 
		return alt_day; 
	}
	public void setAlt_day(String alt_day) {
		this.alt_day = alt_day; 
	}
