...
/**
 * BaseTmbrCluHst - ValueObject class for table [TMBR_CLU_HST].
 *
 * <pre>
 ...
 * @since 2019. 02. 16
 */
public class BaseTmbrCluHst extends CommonBean
{
	/** clu_hst_seq (CLU_HST_SEQ) */
	private int clu_hst_seq;
	private Integer obj_clu_hst_seq;
	/** clu_seq (CLU_SEQ) */
	private int clu_seq;
	...
	public Integer getObj_clu_hst_seq() {
		return obj_clu_hst_seq; 
	}
	
	public void setClu_hst_seq(int clu_hst_seq) {
		this.clu_hst_seq = clu_hst_seq;
		this.obj_clu_hst_seq = clu_hst_seq;
	}
