...
<div class="popup alert_popup">
	...
	<p class="foot_btn">
		<button type="button" class="btn_confirm btn_modal_alert">확인</button>
	</p>
</div>
<!-- CONFIRM -->
<div class="popup confirm_popup">
	...
	<p class="foot_btn">
		<button type="button" class="btn_confirm btn_modal_confirm">확인</button>
...
<div class="popup error_popup">
	...
	<p class="foot_btn">
		<button type="button" class="btn_confirm btn_modal_error">확인</button>
	</p>
</div>
...
var GlobalLayer = {
	...
	open : function(target, type, msg) {
		...
		$(".btn_modal_close", target).click(function(e) {
			e.preventDefault();
			$("html,body").css("overflow", GlobalLayer.overflow); 
	...
	alert : function(msg, callback) {
		// 레이어 OPEN
		GlobalLayer.open(GlobalLayer.target.alert, "alert", msg);
		
		// 확인 버튼 클릭 시
		$(".btn_modal_alert", GlobalLayer.target.alert).click(function(e) {
			e.preventDefault();
	...
	confirm : function(msg, callback) {
		// 레이어 OPEN
		GlobalLayer.open(GlobalLayer.target.confirm, "confirm", msg);
		
		// 확인 버튼 클릭 시
		$(".btn_modal_confirm", GlobalLayer.target.confirm).click(function(e) {
			e.preventDefault();
	...
	error : function(msg, callback) {
		// 레이어 OPEN
		GlobalLayer.open(GlobalLayer.target.error, "error", msg);
		
		// 확인 버튼 클릭 시
		$(".btn_modal_error", GlobalLayer.target.error).click(function(e) {
			e.preventDefault();
